//MODELO
//Crea un objeto con los atributos iniciales del proyecto, esta funcion anonima se llama a si misma para no contaminar el scout del proyecto
(function(){
...
//Modificar los prototype de la clase para poner los metodos de this.state = {
...
//VISTA
//Clase que se encarga de manejar la vista
(function(){
    self.BoardView = function(canvas, board){
        ...
        this.board = board;
        // Objeto desde el cual podemos dibujar en js
